...
class HT_CTC_Admin_Main_Page {
    ...
    function chat_shortcode_cb() {
        ?>
        <p class="description card-panel" style="padding: 18px;">Shortcodes for Chat: [ht-ctc-chat] - <a target="_blank" href="https://www.holithemes.com/plugins/click-to-chat/shortcodes-chat">more info</a></p>
        <?php
    }
